...
<html>
    ...
    <body> 
        ...
        <text x="<%= (shedLength) / 2%>" y="<%= shedWidth - 325%>" font-size="15px" text-anchor="middle" alignment-baseline="middle">Skurets Længde: <%= shedLength%>cm </text>
        ...
        <line x1="15" y1="<%= shedWidth + -310%>" x2="<%= shedLength - 15%>" y2="<%= shedWidth + -310%>" stroke="#000" stroke-width="3" 
              marker-end="url(#endarrow)" marker-start="url(#startarrow)" />
